...
namespace TianZhang.Tests.PlayMode
{
    ...
    {
        [UnityTest]
        public IEnumerator Fixed1920By1080MatrixKeepsAllSixEventsOnTacticalSpriteRoot()
        {
            ...
            GameObject group = GameObject.Find("TacticalSpriteProbeGroup");
            Assert.IsNotNull(group, "AdventureScene must persist the isolated tactical sprite group.");
