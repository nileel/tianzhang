...
namespace TianZhang.Tests
{
    ...
    public sealed class CharterSiteDataTests
    {
        ...
        {
            var sites = SettlementContentImporter.ParseCharterSites(
                new[] { Header, ValidRow },
                "CharterSites.csv",
                BuildLanguage(),
                BuildCatalog(),
        ...
        {
            var duplicate = Assert.Throws<InvalidDataException>(() => SettlementContentImporter.ParseCharterSites(
        ...
        public void ParseCharterSitesRejectsUnknownLanguageKey()
        {
            ...
            var exception = Assert.Throws<InvalidDataException>(() => SettlementContentImporter.ParseCharterSites(
