...
namespace TianZhang.Features.Settlement
{
    ...
    public sealed class SettlementView : MonoBehaviour
    {
        ...
        public void Configure(
            ...
            Button nextSaveAndReturnButton,
            ...
            CharterSiteView nextCharterSiteView)
        {
            ...
            saveAndReturnButton = nextSaveAndReturnButton;
            bountyBoardView = nextBountyBoard;
            ...
            out string reason)
        {
            ...
            {
                reason = SettlementController.CharterSitePanelMissingReason;
                return false;
            }
        ...
        public void SetSaveAndReturnAction(Action action)
        {
            if (saveAndReturnButton == null) return;
            saveAndReturnButton.onClick.RemoveAllListeners();
            if (action != null) saveAndReturnButton.onClick.AddListener(() => action());
        }

        public void ShowSaveResult(string reason)
        {
            EnsureLanguageLoaded();
            SetStatus(UiText.ReasonDisplay(reason, "保存失败"));
        }
