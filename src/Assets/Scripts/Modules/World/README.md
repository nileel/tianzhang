...
- 公开入口：`WorldClockService`、Quest／Inventory／NPC／Bounty／Charter 状态所有者及 `CharterCommitService`。
...
- 直接测试：`AssemblyBoundaryEditorTests`、`WorldStateStoreTests`、`CharterCommitServiceTests`。
