...
- 公开入口：`WorldClockService`、Quest／Inventory／Npc／Bounty／Charter store、`InventoryGrantUseCase`、`BountyUseCase`、`CharterUseCase`、`CharterCommitService`。
...
- 数据／配置来源：Content 中的世界／悬赏／册界定义、稳定 ID 与显式操作输入。
