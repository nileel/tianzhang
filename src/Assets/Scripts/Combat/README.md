...
- 直接测试：`CombatRuntimeKernelTests` 覆盖 1v1／2v2、CTB、伤害、范围、拒绝原因、移动、换法、七类合法行动、结果投影及纯度；既有 `AttackProfileDataTests`、`SpellDamageMultiplierTests`、`GuanzhongFormalEndToEndTests` 继续覆盖旧生产路径。
