...
namespace TianZhang.Game.CharacterCreation
{
    public static class CharacterCreationRules
    {
            ...
            CharacterCreationPointBuyConfig pointBuyConfig)
        {
            ...
            var sectRoute = CharacterCreationCatalog.FindSectRoute(draft.SectRouteId)
                ?? CharacterCreationCatalog.FindSectRoute("route_sanxiu");
            ...
            profile.gongFaName = sectRoute != null ? sectRoute.GongFaName : "";
            profile.equippedSpells = sectRoute != null ? CloneArray(sectRoute.StartingSpells) : new string[0];
