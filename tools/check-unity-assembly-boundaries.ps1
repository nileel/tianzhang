...
if (-not $SkipRequiredAssemblies) {
  $required = [ordered]@{
    ...
    'TianZhang.Features.Adventure' = @('src/Assets/Scripts/Modules/Features/Adventure/TianZhang.Features.Adventure.asmdef', @('TianZhang.Foundation', 'TianZhang.Content', 'TianZhang.Character', 'TianZhang.World', 'TianZhang.Combat', 'TianZhang.Gameplay.Contracts', 'TianZhang.Spatial', 'TianZhang.Infrastructure.UnityContent', 'UnityEngine.UI'))
    'TianZhang.Features.CombatPresentation' = @('src/Assets/Scripts/Modules/Features/CombatPresentation/TianZhang.Features.CombatPresentation.asmdef', @('TianZhang.Foundation', 'TianZhang.Gameplay.Contracts', 'UnityEngine.UI'))
