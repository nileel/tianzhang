...
# 工作规则
- ✅ 已审核 — 2026-06-16 Codex / ChatGPT5.5 复审通过：双 AI 沟通协作工作流已更新。
- 思考时尽量使用中文进行推理和分析。
...
| `开发管理/AI协作规则.txt` | ChatGPT5.5 / DeepSeek V4 Pro 分工、交接、返工与冲突处理（✅ 已审核） |
| `开发管理/AI合作沟通.txt` | DeepSeek ↔ Codex / ChatGPT5.5 的交接记录、疑点、待复审项与协作备忘（✅ 已审核） |
| `开发管理/DeepSeek工作提示词.txt` | DeepSeek API 工作提示词、交接输出格式与任务类型模板（✅ 已审核） |
